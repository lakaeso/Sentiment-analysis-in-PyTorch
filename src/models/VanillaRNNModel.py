...
class VanillaRNNModel(nn.Module, AbstractModel):
    ...
    def __init__(self, config: dict) -> None:
        ...
        # network
        self.rnn1 = nn.RNN(300, 150, 2, batch_first=False)
        self.rnn2 = nn.RNN(150, 150, 2, batch_first=False)
    ...
    def train_(self, verbose=False):
        ...
        for i_epoch in range(1, self.num_epoch + 1):
            ...
            if verbose:
                print(f"... Vanilla RNN model starting epoch {i_epoch}")
            ...
            if verbose:
                print(f"... Vanilla RNN model epoch {i_epoch}, eval acc={eval_acc:.2f}")
        
        if verbose:
            print(f"... Vanilla RNN model finished training, test acc={test_acc:.2f}")
    ...
    def get_parameters(self):
        ...
        parameters.extend(list(self.rnn2.parameters()))
